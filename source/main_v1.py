...
os.makedirs("../Datos_csv_creados/", exist_ok=True)
...
#la linea de arriba no tenia el .tocsv
...
#df_espanoles_con_victorias = df_stats_espanoles[df_stats_espanoles['num_victorias'] > 1]
# Creamos la gráfica de barras para estos pilotos
#plt.figure(figsize=(10, 6))
#vbars = plt.bar(df_espanoles_con_victorias['surname'], df_espanoles_con_victorias['num_victorias'], color='salmon')
#plt.xlabel('Piloto')
